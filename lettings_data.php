                        ...
                        <table class="table table-bordered table-hover" style="width:100%;" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="#" onclick="bollocks('<?=$row["user_id"]?>')"> <i class="far fa-plus-square"></i> </a>
                                    </td>
                                    <td colspan="17" id="bollocks<?=$row['user_id']?>" style="display:none">
                                        <a href="javascript:edt_id('<?php echo $row['user_id']; ?>')"><i class="far fa-edit"></i></a>
                                         <?php
                                        $date = date("H");
                                        if ($date < "12:00") {
                                        ...
                                        <a href="javascript:delete_id('<?php echo $row['user_id']; ?>')"><i class="far fa-trash-alt"></i></a>
                                        <ul>
                                            <?=$row['contact_number']?>
