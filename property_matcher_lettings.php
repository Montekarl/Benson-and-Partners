...
if($result->num_rows >0){
    while($row =  $result->fetch_assoc()) {
        ...
        $date = date("H");
        if ($date < "12:00") {
            $sms="Good Morning ".$firstname.", <br> It's Karl from Benson and Partners. Many thanks for your interest for the ".$minbedrooms." bedroom. <br>
            <br>
            ...
            <br>
            You could also simply text me 'call me' 'if that's more convenient for you. ";
            
        } else {
            $sms="Good Afternoon ".$firstname.", <br> It's Karl from Benson and Partners. Many thanks for your interest for the ".$minbedrooms." bedroom. <br>
            <br>
            Let me know on below information by texting back, calling 0208 653 3444 or emailing karl@bensonpartners.co.uk.<br>
            <br>
            What's your availability for viewings?<br>
