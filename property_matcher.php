...
<div id="body">
    <div id="content">
        <table style ="width:100%">
            ...
            <!-- SEARCH FUCTIONALITY START-->

    <!-- SEARCH FUCTIONALITY END-->
    </table>
...
if($result->num_rows >0){
    while($row =  $result->fetch_assoc()){
        ...
        $date = date("H");
        if ($date < "12:00") {
            $sms="Good Morning ".$firstname.", It's Karl from Benson and Partners. Many thanks for your interest. Please see ".$minbedrooms." bedroom properties within your budget below.  Let me know if you would like to book a viewing or have any questions by texting back, calling 0208 653 3444 or emailing karl@bensonpartners.co.uk.";
        } else {
            $sms="Good Afternoon ".$firstname.", It's Karl from Benson and Partners. Many thanks for your interest. Please see ".$minbedrooms." bedroom properties within your budget below.  Let me know if you would like to book a viewing or have any questions by texting back, calling 0208 653 3444 or emailing karl@bensonpartners.co.uk.";
        }
...
<form name="form1">
    <table>
        ...
        <br/>
        <textarea rows='20' cols='40' name="textareaaccept" style="width:200px;height:100px;"></textarea>
    </table>
</form>
        <?php
        $date=date("H");
